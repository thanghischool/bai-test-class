    ...
    <header class="header-section">
        <div class="header-top">
            <div class="container">
                ...
                <div class="ht-right">
                    <a href="dangnhap.php" class="login-panel"><i class="fa fa-user"></i><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : "Login"; ?></a>
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="product-item">
                                            <div class="pi-pic">
                                                ...
                                                <ul>
                                                    <li class="w-icon active"><a href="detail.php?id=<?php echo $row['id'] ?>"><i class="icon_bag_alt"></i></a></li>
                                                    <li class="quick-view"><a href="#">+ Add Cart</a></li>
                                                    <li class="w-icon"><a href="#"><i class="fa fa-random"></i></a></li>
                                                </ul>
                                            </div>
                                            <div class="pi-text">
                                                <div class="catagory-name"><?php echo $row['id']; ?></div>
                                                <a href="#">
